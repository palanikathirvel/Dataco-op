...
-- AlterTable
ALTER TABLE "CohortTag" ADD COLUMN     "confidenceScore" DOUBLE PRECISION NOT NULL DEFAULT 1.0;
...
-- CreateIndex
CREATE INDEX "Purchase_perceptualHash_idx" ON "Purchase"("perceptualHash");
